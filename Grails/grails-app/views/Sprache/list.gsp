...
<%@ page import="org.example.demo.Sprachen" %>
<!doctype html>
<html>
	<head>
		<meta name="layout" content="bootstrap">
		<g:set var="entityName" value="${message(code: 'Sprachen.label', default: 'Sprache')}" />
	...
	<body>
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<g:form url='[controller: "sprache", action: "index"]' id="search" name="search" method="get">
				...
				<table class="table table-striped">
					<thead>
						<tr>
							...
							<g:sortableColumn property="name" title="${message(code: 'Sprachen.name.label', default: 'Sprache')}" />
