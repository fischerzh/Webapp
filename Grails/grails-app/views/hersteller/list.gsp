	...
	<body>
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<g:form url='[controller: "hersteller", action: "index"]' id="search" name="search" method="get">
				...
				<table class="table table-striped">
					<thead>
						<tr>
							...
							<g:sortableColumn property="name" title="${message(code: 'Hersteller.name.label', default: 'Hersteller')}" />
