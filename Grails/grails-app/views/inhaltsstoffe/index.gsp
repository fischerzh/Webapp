...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'Inhaltsstoffe.label', default: 'Inhaltsstoffe')}" />
	...
	<body>
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<g:form url='[controller: "inhaltsstoffe", action: "index"]' id="search" name="search" method="get">
				...
				<table class="table table-striped">
					<thead>
						<tr>	
							<g:sortableColumn property="name" title="${message(code: 'Inhaltsstoffe.name.label', default: 'Name')}" />
					...
					<g:each in="${objInstanceList}" var="objInstance">
						<tr>
							...
							<td>
								<g:each in="${objInstanceList }" var="Inhaltsstoffe">
									${Inhaltsstoffe.name }
								</g:each>
							</td>
