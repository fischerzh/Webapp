	...
	<body>
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<g:form url='[controller: "ort", action: "index"]' id="search" name="search" method="get">
				...
				<table class="table table-striped">
					<thead>
						<tr>	
							...
							<g:sortableColumn property="land" title="${message(code: 'Ort.landList.label', default: 'Land')}" />						
							<th></th>
						</tr>
					</thead>
					<tbody>
					<g:each in="${objInstanceList}" var="objInstance">
						<tr>
							...
							<td>${fieldValue(bean: objInstance, field: "land")}</td>
