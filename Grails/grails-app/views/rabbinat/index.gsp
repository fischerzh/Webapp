...
<%@ page import="org.example.demo.Rabbinat" %>
<!doctype html>
<html>
	<head>
		<meta name="layout" content="bootstrap">
		<g:set var="entityName" value="${message(code: 'Rabbinat.label', default: 'Rabbinat')}" />
		...
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<table class="table table-striped">
					<thead>
						<tr>	
							<g:sortableColumn property="name" title="${message(code: 'Rabbinat.name.label', default: 'Name')}" />
					...
					<g:each in="${objInstanceList}" var="objInstance">
						<tr>
							...
							<td>
								<g:each in="${objInstanceList }" var="Rabbinat">
									${Rabbinat.name }
								</g:each>
							</td>
