		...
		<div class="row-fluid">
			...
			<div class="span3">
				<div class="well">
					<ul class="nav nav-list">
						...
						<li>
							<g:link class="index" action="index">
								<i class="icon-list"></i>
			...
			<div class="span9">
				...
				<dl>
					...
					<g:if test="${objInstance?.verpackung}">
						<dt><g:message code="Verpackung_werte.name.label" default="Name" /></dt>
						
							<dd><g:fieldValue bean="${objInstance}" field="verpackung"/></dd>
